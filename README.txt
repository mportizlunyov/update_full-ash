Update_Full [ASH] is a suite of Free & Open-Source scripts written in several shell scripts that allows for simple, customisable, and full updating of a wide variety of popular UNIX distributions through their respective package managers.
...
Copyright (C) 2022  Mikhail Patricio Ortiz-Lunyov
    Update_Full-ASH is a script that allows for automatic updating of many
